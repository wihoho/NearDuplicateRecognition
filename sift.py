...
def siftFeature(imagePath):
    process_image(imagePath, "data/temp.sift")
    locations, features = read_features_from_file("data/temp.sift")
...
def read_features_from_file(filename):
    ...
    f = loadtxt(filename)
    return f[:,:2],f[:,4:] # feature locations, descriptors
